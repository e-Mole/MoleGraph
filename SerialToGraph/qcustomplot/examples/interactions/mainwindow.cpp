...
void MainWindow::titleDoubleClick(QMouseEvent* event, QCPPlotTitle* title)
{
  ...
  bool ok;
  QString newTitle = QInputDialog::getText(this, "QCustomPlot example", "New plot title:", LineEdit::Normal, title->text(), &ok);
  if (ok)
  {
...
void MainWindow::axisLabelDoubleClick(QCPAxis *axis, QCPAxis::SelectablePart part)
{
  ...
  {
    bool ok;
    QString newLabel = QInputDialog::getText(this, "QCustomPlot example", "New axis label:", LineEdit::Normal, axis->label(), &ok);
    if (ok)
    {
...
void MainWindow::legendDoubleClick(QCPLegend *legend, QCPAbstractLegendItem *item)
{
  ...
  if (item) // only react if item was clicked (user could have clicked on border padding of legend where there is no item, then item is 0)
  {
    ...
    bool ok;
    QString newName = QInputDialog::getText(this, "QCustomPlot example", "New graph name:", LineEdit::Normal, plItem->plottable()->name(), &ok);
    if (ok)
    {
