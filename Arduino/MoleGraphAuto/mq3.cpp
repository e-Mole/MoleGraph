...
float MQ3::read(uint8_t _spec) {
  ...
  switch (_spec) {
    case 0: result = BAC; BAC = NO_DATA; break;          // BAC in mg/l or ppm
    case 1: result = BAC/10000; BAC = NO_DATA; break;    // BAC in %
    case 2: result = voltage; voltage = NO_DATA; break;  // Voltage
    case 3: result = value; value = NO_DATA; break;      // RAW
    case 4: result = value2; value2 = NO_DATA; break;    // trigger 0/1	
  }
  return result;
}
