...
float PH::read(uint8_t _spec) {
  ...
  switch (_spec) {
    case 0: result = pH_probe; pH_probe = NO_DATA; break; // pH
    case 1: result = voltage; voltage = NO_DATA; break;   // Voltage
    case 2: result = value; value = NO_DATA; break;       // RAW
    case 3: result = value2; value2 = NO_DATA; break;     // trigger 0/1	
  }
  return result;
}
